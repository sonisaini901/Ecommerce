...
export const logoutUser = () => async (dispatch,getState) => {
    try {
        ...
        // window.localStorage.setItem('appliedCoupon', JSON.stringify(getState().appliedCode.appliedCoupon));
